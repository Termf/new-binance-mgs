...
public class LoginVerifyMfaArg implements Serializable {

    private static final long serialVersionUID = 4123850312438586780L;

    // loginV3### 理论上不需要email\mobile参数了，继续传这3个，是因为要记录log，用户是使用email或mobile哪种方式登录的

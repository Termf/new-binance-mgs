...
@Data
@ApiModel("交易详情")
public class TradeInfoRet implements Serializable {

    private static final long serialVersionUID = 6003308079360471409L;
    ...
    @ApiModel("用户交易等级费率信息")
    @Data
    public static class UserGas implements Serializable {
